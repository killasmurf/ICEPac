...
class ResourceAssignment(Base):
    ...
    resource_code = Column(String(50), ForeignKey("resources.resource_code"), nullable=False)
    supplier_code = Column(String(50), ForeignKey("suppliers.supplier_code"), nullable=True)
    ...
    estimating_technique_code = Column(String(50), ForeignKey("estimating_techniques.code"), nullable=True)
    ...
    def pert_estimate(self) -> float:
        ...
        return float((self.best_estimate + 4 * self.likely_estimate + self.worst_estimate) / 6)
    ...
    def __repr__(self):
        return f"<ResourceAssignment(id={self.id}, wbs={self.wbs_id}, resource='{self.resource_code}')>"
