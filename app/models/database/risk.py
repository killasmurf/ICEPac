...
class Risk(Base):
    ...
    risk_category_code = Column(String(50), ForeignKey("risk_categories.code"), nullable=True)
    risk_cost = Column(Numeric(18, 2), default=0)
    probability_code = Column(String(50), ForeignKey("probability_levels.code"), nullable=True)
    severity_code = Column(String(50), ForeignKey("severity_levels.code"), nullable=True)
