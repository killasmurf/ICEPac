...
class MockResource:
    """Mock Resource model."""
    def __init__(self, id=1, resource_code="ENG-SR", description="Senior Engineer",
                 eoc="LABOR", cost=Decimal("150.00"), units="hour", is_active=True):
        self.id = id
...
class MockSupplier:
    """Mock Supplier model."""
    def __init__(self, id=1, supplier_code="ACME", name="Acme Corporation",
                 contact="John Smith", phone="+1-555-0100", email="john@acme.com",
...
class MockWeightedConfigItem:
    ...
    def __init__(self, id=1, code="HIGH", description="High probability",
                 weight=Decimal("0.75"), is_active=True):
        self.id = id
        self.code = code
        self.description = description
        self.weight = weight
...
class MockAuditLog:
    """Mock AuditLog model."""
    def __init__(self, id=1, user_id=1, action="CREATE", entity_type="Resource",
                 entity_id=1, old_values=None, new_values=None):
        self.id = id
...
class TestResourceRepository:
    ...
    def test_get_by_code_finds_resource(self):
        ...
        with patch('app.repositories.resource_repository.ResourceRepository') as MockRepo:
    ...
    def test_search_finds_matching_resources(self):
        ...
        resources = [MockResource(resource_code="ENG-SR", description="Senior Engineer")]
...
class TestSupplierRepository:
    ...
    def test_get_by_code_finds_supplier(self):
        ...
        with patch('app.repositories.supplier_repository.SupplierRepository') as MockRepo:
            mock_repo = MockRepo.return_value
...
class TestResourceService:
    ...
    def test_create_resource_succeeds_with_unique_code(self):
        ...
        with patch('app.services.resource_service.ResourceRepository') as MockRepo:
            ...
            resource_in.model_dump.return_value = {"resource_code": "NEW-RES", "description": "New Resource"}
...
class TestSupplierService:
    ...
    def test_create_supplier_succeeds_with_unique_code(self):
        ...
        with patch('app.services.supplier_service.SupplierRepository') as MockRepo:
            ...
            supplier_in.model_dump.return_value = {"supplier_code": "NEW-SUP", "name": "New Supplier"}
...
class TestConfigService:
    ...
    def test_create_config_item_raises_conflict_for_duplicate_code(self):
        ...
        with patch('app.services.config_service.ConfigService') as MockService:
            mock_service = MockService.return_value
            mock_service.create.side_effect = HTTPException(status_code=409, detail="Code exists")
...
class TestResourceSchemas:
    ...
    def test_resource_create_uppercases_code(self):
        ...
        resource = ResourceCreate(resource_code="lower", description="Test", cost=Decimal("100"))
...
class TestConfigSchemas:
    ...
    def test_weighted_config_item_validates_weight_range(self):
        ...
        with pytest.raises(ValidationError):
            WeightedConfigItemCreate(code="TEST", description="Test", weight=Decimal("150"))
...
class TestAdminIntegration:
    ...
    def test_full_resource_crud_workflow(self):
        ...
        updated_resource = MockResource(id=1, resource_code="TEST-RES", description="Updated")
        ...
        with patch('app.services.resource_service.ResourceRepository') as MockRepo:
            ...
            create_in.model_dump.return_value = {"resource_code": "TEST-RES", "description": "Test"}
    ...
    def test_audit_trail_captures_all_changes(self):
        ...
        with patch('app.services.audit_service.AuditRepository') as MockRepo:
            ...
            # Update
            service.log_update("Resource", 1, {"desc": "Old"}, {"desc": "New"}, user_id=1)
